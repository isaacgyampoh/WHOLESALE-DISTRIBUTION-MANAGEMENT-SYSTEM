...
-- The record
-- ------------------------------------------------------------------
create type public.supplier_document_kind as enum (
  'invoice', 'delivery_note', 'waybill', 'credit_note',
...
drop trigger if exists supplier_documents_touch on public.supplier_documents;
...
drop policy if exists supplier_documents_objects_read on storage.objects;
...
drop policy if exists supplier_documents_objects_write on storage.objects;
...
drop policy if exists supplier_documents_objects_delete on storage.objects;
