-- ====================================================================
-- UPGRADE 0041 - a receipt the customer can actually open
-- ====================================================================
--
-- For a database installed before migration 0041.
-- Run it in the Supabase SQL editor.
--
-- GENERATED FILE - do not edit by hand.
-- Source: supabase/migrations/0041_a_receipt_the_customer_can_open.sql
...
-- ====================================================================
select 'receipt links exist' as check,
