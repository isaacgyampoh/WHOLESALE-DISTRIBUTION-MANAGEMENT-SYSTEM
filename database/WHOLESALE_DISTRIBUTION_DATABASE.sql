...
-- ====================================================================
-- 0038_priced_view_carries_the_picture.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0039_a_name_to_sign_in_with.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0040_counting_attempts_by_device_too.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0041_a_receipt_the_customer_can_open.sql
-- ====================================================================
-- ===================================================================
...
drop policy if exists receipt_tokens_select on public.receipt_tokens;drop policy if exists receipt_tokens_select on public.receipt_tokens;
...
-- ====================================================================
-- 0042_a_salesperson_sells_from_their_own_van.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0045_the_warehouse_dispatches.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0046_van_loads_stop_reading_cost_directly.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0047_stock_moves_between_vans.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0062_a_piece_with_no_price_is_not_sold.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0063_stock_that_cannot_be_sold.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0064_a_van_can_be_topped_up_mid_week.sql
-- ====================================================================
-- ===================================================================
...
drop policy if exists van_load_top_ups_read on public.van_load_top_ups;drop policy if exists van_load_top_ups_read on public.van_load_top_ups;
create policy van_load_top_ups_read on public.van_load_top_ups
  for select using (org_id = public.auth_org_id());


drop policy if exists van_load_top_ups_write on public.van_load_top_ups;drop policy if exists van_load_top_ups_write on public.van_load_top_ups;
...
-- ====================================================================
-- 0065_stock_can_go_back_mid_week.sql
-- ====================================================================
-- ===================================================================
...
drop policy if exists van_midweek_returns_read on public.van_midweek_returns;drop policy if exists van_midweek_returns_read on public.van_midweek_returns;
create policy van_midweek_returns_read on public.van_midweek_returns
  for select using (org_id = public.auth_org_id());


drop policy if exists van_midweek_returns_write on public.van_midweek_returns;drop policy if exists van_midweek_returns_write on public.van_midweek_returns;
...
-- ====================================================================
-- 0066_the_piece_columns_are_readable.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0067_selling_over_the_counter.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0068_a_salesperson_can_see_the_shelf.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0069_a_sale_opens_the_carton_it_sells_from.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0070_the_phone_is_told_about_the_pieces.sql
-- ====================================================================
-- ===================================================================
...
-- ====================================================================
-- 0071_the_shelf_and_the_ledger_must_agree.sql
-- ====================================================================
-- ===================================================================
