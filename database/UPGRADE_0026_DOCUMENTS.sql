-- ====================================================================
-- UPGRADE 0026 - invoices, receipts and waybills
-- ====================================================================
--
-- For a database installed before migration 0026.
-- Run it in the Supabase SQL editor.
--
-- GENERATED FILE - do not edit by hand.
-- Source: supabase/migrations/0026_invoices_receipts_waybills.sql
...
-- ====================================================================
select 'invoices linked to van sales' as check,
