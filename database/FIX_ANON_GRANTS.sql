...
-- Anonymous privilege repair, for a database that is ALREADY INSTALLED.
--
-- WHEN TO RUN THIS
--   Only if VERIFY_DATABASE.sql row 16, "anon cannot read any table or
--   view", reports FAIL with a number other than 0.
--
-- WHAT IT DOES
--   Removes table, sequence and function privileges from the anon role,
--   and stops future objects being granted to it. Signed-in roles keep
--   exactly the access they already had.
--
-- WHAT IT DOES NOT DO
--   It creates no tables, drops nothing, and touches no business data.
--   It is safe to run more than once.
--
-- HOW TO RUN
--   Supabase -> SQL Editor -> New query -> paste -> Run.
--   Then run VERIFY_DATABASE.sql again: row 16 should read 0 / OK and
--   row 18 "anon legacy grant rows" should read 0.
--
-- HOW TO COPY
--   Open this file and press Ctrl+A / Cmd+A. The leading blank lines
--   protect against a selection that clips the first few characters.
